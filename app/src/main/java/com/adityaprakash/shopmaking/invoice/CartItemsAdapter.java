...
public class CartItemsAdapter extends RecyclerView.Adapter<CartItemsAdapter.MyViewHolder> {
    ...
    public CartItemsAdapter(Context context, ArrayList<Items> itemsArrayList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        final Items item = itemsArrayList.get(position);
...
//                                    final TextInputEditText eItemName = alertLayout.findViewById(R.id.item_name);
                            ...
                            //final TextInputEditText location = alertLayout.findViewById(R.id.location3);
...
//                                            String firstEntry = eItemName.getText().toString();
                                   ...
                                   // String fourthEny = location.getText().toString();
